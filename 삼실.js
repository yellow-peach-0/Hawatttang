...
const title = document.querySelector("#title").getBoundingClientRect().y
const info = document.querySelector("#info").getBoundingClientRect().y
const process = document.querySelector("#process").getBoundingClientRect().y
const value = document.querySelector("#vision").getBoundingClientRect().y
const menual = document.querySelector("#ds_concept").getBoundingClientRect().y
const credit = document.querySelector("#credit").getBoundingClientRect().y


function defaultcolor() {
   if (allContainer.scrollTop = title) {
